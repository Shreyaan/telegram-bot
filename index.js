...
ctx.reply('Hello ' + ctx.message.from.first_name ,{reply_to_message_id : ctx.message.reply_to_message.message_id} ))

bot.hears([/@trbhater_bot/], (ctx)=> 
ctx.reply('kya hai ' + ctx.message.from.first_name ,{reply_to_message_id : ctx.message.reply_to_message.message_id} ))

bot.hears([/trb/, /TRB/, /Trb/, /teeaarbee/], (ctx) => {
  ctx.reply('dont mention trb i hate him' , {reply_to_message_id : ctx.message.reply_to_message.message_id})
})
