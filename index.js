...
ctx.reply('Hello ' + ctx.message.from.first_name , Extra.inReplyTo(message_id) ))

bot.hears([/@trbhater_bot/], (ctx)=> 
ctx.reply('kya hai ' + ctx.message.from.first_name , Extra.inReplyTo(message_id) ))

bot.hears([/trb/, /TRB/, /Trb/, /teeaarbee/], (ctx) => {
  ctx.reply('dont mention trb i hate him' , Extra.inReplyTo(message_id))
})
